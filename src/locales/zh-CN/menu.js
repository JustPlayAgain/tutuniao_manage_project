export default {
  ...
  'menu.activity': '国美大赛',
  'menu.activity.list': '大赛列表',
  'menu.activity.add': '添加大赛和评测',
  'menu.match': '结业证书',
  'menu.match.list': '学员列表',
  'menu.match.addMatch': '添加学员',
  'menu.match.uploadFile': '批量添加',
  'menu.guoMei': '国美证书',
  'menu.guoMei.searchtable': '学员列表',
  'menu.guoMei.add': '添加学员',
  'menu.guoMei.uploadFile': '批量添加',
};
